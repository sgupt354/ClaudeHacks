          ...
          <div style={{ marginTop: 8 }}>
            ...
            <button
              onClick={() => {
                ...
                const loc = result.location_extracted || result.location || "";
                router.push(`/similar?issue_type=${encodeURIComponent(issueType)}&location=${encodeURIComponent(loc)}&from_id=${encodeURIComponent(rid || "")}`);
              }}
